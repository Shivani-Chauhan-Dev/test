...
# l = list(map(lambda x:x+x+x,list1))
# print(l)
...
# l2 = [6,4,3,8]
# l3 = [8,6,2,9]
# list1 =list (map(lambda x,y,z:x+y+z,l1,l2,l3))
# print(list1)


# 3. Write a Python program to listify the list of given strings individually using Python map.
# color = ["red","green","blue","black","brown","white"]
# list1 = map(list,color)
# for x in list1:
#     print(x)
# print(list(list1))
...
# l1 =list (filter(lambda x: x["id"] == 10 , list1))
# for i in l1:
#     print(i)

# l2 = [1,5,6,9]
# l3 = list(filter(lambda x: x["id"] in l2 ,list1))
# print(l3)
# user_name =[x["name"] for x in l3]
# print(user_name)
# user_name = []
# for x in l3:
#     l=x["name"]
...
# l4 = list(map(lambda x: x["name"],l3))
# print(l4)

# l5 = list(map(lambda x: x["address"],l3))
# print(l5)
...
# l1 = list(filter(lambda x: x["userId"]%2==0,list2))
# for x in l1:
#     print(x)


# newList = [6,8,9,12,4,14,16,7,18,20,16]
# l2 = list(filter(lambda x: x["id"] in newList,list2))
# print(l2)
# l3 = list(map(lambda x : x["title"],x["id"] l2))
# print(l3)
...
# l4 = [x["body"] for x in l2]
# print(l4)

list1 = [[1,6],[2,8]]
l1 = [x for x in list1.split(",")]
print(l1)
